...
Analista de Infraestrutura com mais de 14 anos de experiência em ambientes corporativos, atuando com administração de servidores Windows e Linux, Active Directory, virtualização, redes, banco de dados SQL Server, automação e sustentação de ambientes críticos.
...
## Tecnologias
Linux · Windows Server · Active Directory · Virtualização · SQL Server · Docker · GitHub Actions · Python · FastAPI · Trivy · Git · Bash
